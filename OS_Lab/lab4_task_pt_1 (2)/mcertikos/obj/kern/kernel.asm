...
void seg_init(int cpu_idx)
{
  ...
  104b4e:	c7 c0 36 79 13 00    	mov    $0x137936,%eax
...
static void kern_main_ap(void)
{
  ...
  105e28:	c7 c5 0a 46 12 00    	mov    $0x12460a,%ebp
  ...
  105ed8:	c7 c5 02 ac 11 00    	mov    $0x11ac02,%ebp
...
void sys_spawn(tf_t *tf)
{
  ...
  107917:	c7 c2 02 ac 11 00    	mov    $0x11ac02,%edx
  ...
  107950:	c7 c2 f2 df 12 00    	mov    $0x12dff2,%edx
  ...
  10797c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    switch (elf_id) {
  107980:	c7 c2 0a 46 12 00    	mov    $0x12460a,%edx
