...
00000000 <.debug_line>:
 ...
 4a4:	00 00                	add    %al,(%eax)
 4a6:	00 34 00             	add    %dh,(%eax,%eax,1)
 4a9:	00 00                	add    %al,(%eax)
 4ab:	02 01                	add    (%ecx),%al
 4ad:	1f                   	pop    %ds
 4ae:	02 0f                	add    (%edi),%cl
 4b0:	03 73 00             	add    0x0(%ebx),%esi
 4b3:	00 00                	add    %al,(%eax)
 4b5:	01 73 00             	add    %esi,0x0(%ebx)
 4b8:	00 00                	add    %al,(%eax)
 4ba:	01 5d 00             	add    %ebx,0x0(%ebp)
 ...
 638:	00 34 00             	add    %dh,(%eax,%eax,1)
 63b:	00 00                	add    %al,(%eax)
 63d:	02 01                	add    (%ecx),%al
 63f:	1f                   	pop    %ds
 640:	02 0f                	add    (%edi),%cl
 642:	02 7f 00             	add    0x0(%edi),%bh
 645:	00 00                	add    %al,(%eax)
 647:	01 7f 00             	add    %edi,0x0(%edi)
...
00000000 <.debug_str>:
  ...
  2f:	61                   	popa
  30:	62 34 5f             	bound  %esi,(%edi,%ebx,2)
  33:	74 61                	je     96 <PR_BOOTABLE+0x16>
  35:	73 6b                	jae    a2 <PR_BOOTABLE+0x22>
  37:	5f                   	pop    %edi
  38:	70 74                	jo     ae <PR_BOOTABLE+0x2e>
  3a:	5f                   	pop    %edi
  3b:	31 2f                	xor    %ebp,(%edi)
  3d:	6d                   	insl   (%dx),%es:(%edi)
  3e:	63 65 72             	arpl   %esp,0x72(%ebp)
  41:	74 69                	je     ac <PR_BOOTABLE+0x2c>
  43:	6b 6f 73 00          	imul   $0x0,0x73(%edi),%ebp
  47:	47                   	inc    %edi
  48:	4e                   	dec    %esi
  49:	55                   	push   %ebp
...
00000000 <.debug_line_str>:
  ...
  1c:	61                   	popa
  1d:	62 34 5f             	bound  %esi,(%edi,%ebx,2)
  20:	74 61                	je     83 <PR_BOOTABLE+0x3>
  22:	73 6b                	jae    8f <PR_BOOTABLE+0xf>
  24:	5f                   	pop    %edi
  25:	70 74                	jo     9b <PR_BOOTABLE+0x1b>
  27:	5f                   	pop    %edi
  28:	31 2f                	xor    %ebp,(%edi)
  2a:	6d                   	insl   (%dx),%es:(%edi)
  2b:	63 65 72             	arpl   %esp,0x72(%ebp)
  2e:	74 69                	je     99 <PR_BOOTABLE+0x19>
  30:	6b 6f 73 00          	imul   $0x0,0x73(%edi),%ebp
