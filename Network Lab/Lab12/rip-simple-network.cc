...
main(int argc, char** argv)
{
    ...
    if (printRoutingTables)
    {
        ...
        Ipv4RoutingHelper::PrintRoutingTableAt(Seconds(0.0), a, routingStream);
        Ipv4RoutingHelper::PrintRoutingTableAt(Seconds(0.0), b, routingStream);
        Ipv4RoutingHelper::PrintRoutingTableAt(Seconds(0.0), c, routingStream);
        Ipv4RoutingHelper::PrintRoutingTableAt(Seconds(0.0), d, routingStream);
