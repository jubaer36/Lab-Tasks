...
{
       0,   127,   127,   128,   132,   133,   134,   135,   139,   144,
     151,   152,   153,   157,   158,   167,   171,   172,   176,   177,
     178,   179
};
#endif
...
static const char *const yytname[] =
{
  ...
  "IDENTIFIER", "'+'", "'-'", "'*'", "'/'", "'^'", "UMINUS", "'\\n'",
  "';'", "'='", "'('", "')'", "$accept", "input", "line", "statement",
  "expr", "term", "factor", "primary", YY_NULLPTR
};
...
{
      -6,     0,    -6,    -6,    -6,    -4,    -6,     3,    -6,     1,
      16,    17,    -6,     7,     3,    -6,    -5,    -6,    -6,     3,
       3,     3,     3,     3,    16,    -6,    17,    17,    -6,    -6,
      -6
};
...
{
       3,     0,     1,    19,    20,    21,     4,     0,     2,     7,
       9,    12,    15,    17,     0,    21,     0,     5,     6,     0,
       0,     0,     0,     0,     8,    18,    10,    11,    13,    14,
      16
};
...
{
       2,    19,    20,     3,     4,     5,     3,     4,    15,    16,
      14,    25,     6,    17,    18,     7,    24,    23,     7,    28,
      29,    30,    19,    20,     0,    21,    22,    26,    27
};

static const yytype_int8 yycheck[] =
{
       0,     6,     7,     3,     4,     5,     3,     4,     5,     7,
      14,    16,    12,    12,    13,    15,    14,    10,    15,    21,
      22,    23,     6,     7,    -1,     8,     9,    19,    20
};
...
{
       0,    18,     0,     3,     4,     5,    12,    15,    19,    20,
      21,    22,    23,    24,    14,     5,    21,    12,    13,     6,
       7,     8,     9,    10,    21,    16,    22,    22,    23,    23,
      23
};
...
#line 140 "parser.y"
            {
                setSymbol((yyvsp[-2].sval), (yyvsp[0].dval));
...
#line 1314 "y.tab.c"
  ...
  case 16: /* factor: primary '^' factor  */
#line 171 "parser.y"
                       { (yyval.dval) = pow((yyvsp[-2].dval), (yyvsp[0].dval)); }
#line 1320 "y.tab.c"
    break;

  case 17: /* factor: primary  */
#line 172 "parser.y"
              { (yyval.dval) = (yyvsp[0].dval); }
#line 1326 "y.tab.c"
    break;
...
#line 1332 "y.tab.c"
  ...
  case 19: /* primary: INTEGER  */
#line 177 "parser.y"
              { (yyval.dval) = (yyvsp[0].dval); }
#line 1338 "y.tab.c"
    break;

  case 20: /* primary: DOUBLE  */
#line 178 "parser.y"
             { (yyval.dval) = (yyvsp[0].dval); }
#line 1344 "y.tab.c"
    break;
...
#line 180 "parser.y"
        {
            int f;
            (yyval.dval) = getSymbolValue((yyvsp[0].sval), &f);
            if (!f)
            {
