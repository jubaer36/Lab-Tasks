...
static const char *const yytname[] =
{
  ...
  "'-'", "'*'", "'/'", "'%'", "'='", "';'", "'('", "')'", "$accept",
  "Program", "StmtList", "Stmt", "Expr", "Term", "Factor", YY_NULLPTR
};
...
{
       0,     0,     0,     2,     4,     0,     1,     3,    14,    15,
       0,     0,     8,    12,     0,     0,     0,     5,     0,     0,
       0,    13,     6,     7,     9,    10,    11
};
...
{
       8,     9,     5,    15,    16,     1,    15,    16,     6,    10,
       7,    21,    17,    18,    19,    20,     0,    24,    25,    26,
      22,    23,    14
};

static const yytype_int8 yycheck[] =
{
       3,     4,    10,     5,     6,     3,     5,     6,     0,    12,
       3,    13,    11,     7,     8,     9,    -1,    18,    19,    20,
      15,    16,    10
};
...
{
       0,     3,    15,    16,    17,    10,     0,    17,     3,     4,
      12,    18,    19,    20,    18,     5,     6,    11,     7,     8,
       9,    13,    19,    19,    20,    20,    20
};
...
#line 56 "parser.y"
                     { (yyval.sval) = newTemp(); emit("ADD", (yyval.sval), (yyvsp[-2].sval), (yyvsp[0].sval)); }
#line 1169 "y.tab.c"
    break;

  case 7: /* Expr: Expr '-' Term  */
#line 57 "parser.y"
                     { (yyval.sval) = newTemp(); emit("SUB", (yyval.sval), (yyvsp[-2].sval), (yyvsp[0].sval)); }
#line 1175 "y.tab.c"
    break;
...
#line 62 "parser.y"
                      { (yyval.sval) = newTemp(); emit("MUL", (yyval.sval), (yyvsp[-2].sval), (yyvsp[0].sval)); }
#line 1187 "y.tab.c"
    break;

  case 10: /* Term: Term '/' Factor  */
#line 63 "parser.y"
                      { (yyval.sval) = newTemp(); emit("DIV", (yyval.sval), (yyvsp[-2].sval), (yyvsp[0].sval)); }
#line 1193 "y.tab.c"
    break;

  case 11: /* Term: Term '%' Factor  */
#line 64 "parser.y"
                      { (yyval.sval) = newTemp(); emit("MOD", (yyval.sval), (yyvsp[-2].sval), (yyvsp[0].sval)); }
#line 1199 "y.tab.c"
    break;
