...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_RBRACKET = 6,                   /* "]"  */
  YYSYMBOL_EQUALS = 7,                     /* "="  */
  YYSYMBOL_NEWLINE = 8,                    /* "end of line"  */
  YYSYMBOL_JUNK = 9,                       /* "illegal character"  */
...
{
       0,   124,   124,   125,   129,   130,   131,   132,   136,   136,
     144,   144
};
#endif
...
static const char *const yytname[] =
{
  ...
  "\"value\"", "\"[\"", "\"]\"", "\"=\"", "\"end of line\"",
  "\"illegal character\"", "$accept", "file", "line", "section", "$@1",
  "pair", "$@2", YY_NULLPTR
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 7: /* line: error "end of line"  */
#line 132 "config.y"
                         { yyerrok; }
#line 1447 "config.tab.c"
    break;

  case 8: /* $@1: %empty  */
#line 136 "config.y"
               { stmt_line = tok_line; }
#line 1453 "config.tab.c"
    break;

  case 9: /* section: "[" $@1 "identifier" "]" "end of line"  */
#line 137 "config.y"
      {
          new_section((yyvsp[-2].str), stmt_line);
          free((yyvsp[-2].str));
      }
#line 1462 "config.tab.c"
    break;

  case 10: /* $@2: %empty  */
#line 144 "config.y"
            { stmt_line = tok_line; }
#line 1468 "config.tab.c"
    break;

  case 11: /* pair: "identifier" $@2 "=" "value" "end of line"  */
#line 145 "config.y"
      {
          new_key((yyvsp[-4].str), (yyvsp[-1].str), stmt_line);
          printf("  %-12s = %-18s (%s)\n", (yyvsp[-4].str), (yyvsp[-1].str), type_of((yyvsp[-1].str)));
          free((yyvsp[-4].str)); free((yyvsp[-1].str));
      }
#line 1478 "config.tab.c"
    break;


#line 1482 "config.tab.c"
